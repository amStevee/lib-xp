        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
            <div className="bg-white shadow-lg rounded-xl p-8 max-w-md w-full text-center">
                <div className={`flex items-center justify-center w-16 h-16 mx-auto rounded-full bg-${info.color}-100 mb-4`}>
                    {status === "success" ? (
                        <svg className={`w-8 h-8 text-${info.color}-600`} fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                ...
                <a
                    href="/login"
                    className={`inline-block px-6 py-2 rounded-lg bg-${info.color}-600 text-white font-semibold shadow hover:bg-${info.color}-700 transition`}
                >
                    Go to Login
                </a>
            </div>
